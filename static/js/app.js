...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "knockout", "lodash", "jquery", "./utils"], factory);
    }
    ...
    var AppViewModel = /** @class */ (function () {
        function AppViewModel() {
            ...
            this.cpu_data_for_plot = ko.pureComputed(function () {
                return lodash_1.default.zip(lodash_1.default.range(_this.cpu_data().length), _this.cpu_data());
            });
            this.mem_data_for_plot = ko.pureComputed(function () {
                return lodash_1.default.zip(lodash_1.default.range(_this.mem_data().length), _this.mem_data());
            });
        }
        AppViewModel.prototype.updateLabels = function () {
            var _this = this;
            jquery_1.default.getJSON("/platform_info", function (data) {
                var d = data.data;
                ...
                _this.nproc(jquery_1.default("#proc_list").find("tbody").find("tr").length);
        ...
        AppViewModel.prototype.setupSlider = function () {
            ...
            jquery_1.default("#time_slider").slider({
                value: init_val,
                min: 1,
                max: 60,
                step: 1,
        ...
        AppViewModel.prototype.chooseSignal = function () {
            var _a;
            var numS = (_a = prompt("Inserisci il codice relativo al segnale che vuoi inviare:", "15")) !== null && _a !== void 0 ? _a : '';
    ...
    ko.bindingHandlers.plot = {
        init: function (element, _valueAccessor, allBindings) {
            var options = allBindings.get("plotOptions");
            options = lodash_1.default.defaults({
                ticks: 10,
                min: 0,
                max: 100
            }, options);
            var plot = jquery_1.default.plot(element, [
                []
            ], {
    ...
    ko.bindingHandlers.procTable = {
        init: function (element, valueAccessor) {
            ...
            var proc_table = jquery_1.default(element);
            var table = proc_table.DataTable({
                ...
                fnRowCallback: function (nRow, aData) {
                    jquery_1.default(nRow).attr("id", "proc_" + aData[1]);
                    return nRow;
                },
            ...
            proc_table.find("tbody").on("click", "tr", function () {
                if (jquery_1.default(this).hasClass("selected")) {
                    ...
                    value.sel_id(jquery_1.default(this).attr("id"));
                }
            });
            proc_table.on("draw.dt", function () {
                if (value.sel_id()) {
                    jquery_1.default("#" + value.sel_id()).addClass("selected");
                }
            });
